...
class PPO(nn.Module):
    ...
    def make_batch(self):
        ...
        (s, a, r,
         s_prime, done_mask, prob_a) = (torch.tensor(s_lst, dtype=torch.float).cuda(),
...
if __name__ == '__main__':
    ...
    from env.CryptoTradingEnvAllIn import CryptoTradingEnvAllIn
    import pandas as pd
    ...
    # Make Env
    train_env = DummyVecEnv([lambda: CryptoTradingEnvAllIn(train_df)])
    test_env = DummyVecEnv([lambda: CryptoTradingEnvAllIn(test_df)])
